...
class PrinterProbe:
    ...
    def _probe(self, speed):
        ...
        self.gcode.respond_info("probe at %.3f,%.3f is z=%.6f  pos=%.6f z_compensation=%.6f"
                                % (epos[0], epos[1], epos[2],pos_new[2],z_compensation))
        return epos[:3]
    ...
    def run_probe(self, gcmd):
        ...
        while len(positions) < sample_count:
            ...
            if max(z_positions) - min(z_positions) > samples_tolerance:
                ...
                gcmd.respond_info("Probe samples exceed tolerance. Retrying...rs_probe")
                self.gcode = self.printer.lookup_object('gcode')
                self.gcode.run_script_from_command("RS_probe")
                toolhead = self.printer.lookup_object('toolhead')
                toolhead.dwell(0.5)
...
class ProbePointsHelper:
    ...
    def start_probe(self, gcmd):
        ...
        while 1:
            ...
            if done or heaters.stop_heating == 1 :
                break

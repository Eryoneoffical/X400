...
class MCU:
    ...
    def _handle_shutdown(self, params):
        ...
        if "Timer too close" in self._shutdown_msg or "Stepper too far" in self._shutdown_msg or "Missed scheduling" in self._shutdown_msg or "Rescheduled timer in the past" in self._shutdown_msg:
            pause_resume = self._printer.lookup_object('pause_resume')
